          ...
          <div className="flex items-center justify-between">
            ...
            <div className="bg-gray-800 rounded-lg px-3 py-2 border border-gray-600 min-w-[120px]">
              <span className="text-xs text-gray-400 font-mono tracking-wider">
                ...
                {Object.keys(oscillatorsRef.current || {}).length > 0 ? 'PLAYING' : 'READY'}
              </span>
            </div>
          </div>
        </div>
        <div className="relative px-4 py-6 bg-gradient-to-b from-gray-800 to-gray-900">
          <div className="relative h-24 w-full max-w-7xl mx-auto">
              ...
              {navItems.map((item, index) => (
                <button
                  ...
                  className={`
                    ...
                    ${activeKey === item.key ? 'from-gray-200 via-gray-100 to-gray-300 shadow-inner transform translate-y-1' : 'shadow-[0_8px_16px_rgba(0,0,0,0.3)]'}
            ...
            <div className="absolute top-1 h-16 w-full max-w-7xl mx-auto">
              {blackKeys.map((blackKey, index) => (
                <button
                  ...
                  className={`
                    ...
                    ${activeKey === blackKey.key ? 'from-gray-700 via-gray-800 to-gray-600 shadow-inner transform translate-y-1' : ''}
                    z-10 group
