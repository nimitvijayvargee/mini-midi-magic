...
export const ProcessSection = () => {
  return (
    <section className="py-20 bg-black relative overflow-hidden" aria-labelledby="process-heading">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 id="process-heading" className="text-4xl md:text-6xl font-bold text-white mb-4 text-gradient-primary">
            THE PROCESS
          </h2>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-4">
            <div className="flex-1 space-y-6">
              <article className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-xl p-6 hover:border-primary/40 transition-all duration-300">
              ...
              <article className="bg-gradient-to-br from-accent/10 to-accent/5 border border-accent/20 rounded-xl p-6 hover:border-accent/40 transition-all duration-300">
              ...
              <article className="bg-gradient-to-br from-led-orange/10 to-led-orange/5 border border-led-orange/20 rounded-xl p-6 hover:border-led-orange/40 transition-all duration-300">
            ...
            <div className="flex-none relative w-32 h-80 flex items-center justify-center" aria-hidden="true">
            ...
            <div className="flex-1">
              <article className="bg-gradient-to-br from-white/10 to-white/5 border border-white/20 rounded-xl p-8 hover:border-white/40 transition-all duration-300 shadow-glow-primary/20">
                <div className="text-center">
                  <div className="w-24 h-24 bg-gradient-to-br from-primary to-accent rounded-full mx-auto mb-6 flex items-center justify-center shadow-glow-primary" aria-hidden="true">
                    <span className="text-3xl" role="img" aria-label="Piano keyboard">🎹</span>
                  </div>
          ...
          <div className="md:hidden space-y-8">
            <div className="space-y-4">
              <article className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-xl p-6">
              ...
              <article className="bg-gradient-to-br from-accent/10 to-accent/5 border border-accent/20 rounded-xl p-6">
              ...
              <article className="bg-gradient-to-br from-led-orange/10 to-led-orange/5 border border-led-orange/20 rounded-xl p-6">
            ...
            <article className="bg-gradient-to-br from-white/10 to-white/5 border border-white/20 rounded-xl p-6 shadow-glow-primary/20">
              <div className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-primary to-accent rounded-full mx-auto mb-4 flex items-center justify-center" aria-hidden="true">
                  <span className="text-xl" role="img" aria-label="Piano keyboard">🎹</span>
                </div>
...
export const KitSection = () => {
  return (
    <section className="py-12 md:py-20 bg-gray-200 relative overflow-hidden" aria-labelledby="kit-heading">
      {/* Background pattern */}
      <div 
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-8 md:mb-16">
          <h2 id="kit-heading" className="text-3xl md:text-4xl lg:text-6xl font-bold text-amber-900 mb-4">
            YOUR KIT
          </h2>
          <p className="text-lg md:text-xl text-amber-700">Everything you need to build your MIDI controller</p>
        </div>
        
        {/* Desktop Kit Board Layout */}
        <div className="hidden md:block max-w-6xl mx-auto relative h-screen bg-gradient-to-br from-amber-200 to-amber-300 rounded-2xl shadow-2xl border-8 border-amber-800">
          ...
          {/* Kit items positioned on the board */}
          {kitItems.map((item, index) => (
            <div
              key={index}
              className={`absolute ${item.position} ${item.rotation} transform hover:scale-105 transition-all duration-300 group`}
            ...
            >
              ...
              {/* Component card */}
              <article className="bg-white rounded-lg shadow-xl border-2 border-gray-200 p-4 w-64 group-hover:shadow-2xl transition-all duration-300">
          ...
          {/* Board corner screws */}
          <div className="absolute top-4 left-4 w-3 h-3 bg-gray-400 rounded-full shadow-md" aria-hidden="true"></div>
          <div className="absolute top-4 right-4 w-3 h-3 bg-gray-400 rounded-full shadow-md" aria-hidden="true"></div>
          <div className="absolute bottom-4 left-4 w-3 h-3 bg-gray-400 rounded-full shadow-md" aria-hidden="true"></div>
          <div className="absolute bottom-4 right-4 w-3 h-3 bg-gray-400 rounded-full shadow-md" aria-hidden="true"></div>
        </div>
        
        {/* Mobile Kit Grid Layout */}
